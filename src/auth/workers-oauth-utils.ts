...
// Adapted verbatim from Cloudflare's remote-mcp-github-oauth demo
// (github.com/cloudflare/ai/tree/main/demos/remote-mcp-github-oauth).

import { type AuthRequest, type ClientInfo } from '@cloudflare/workers-oauth-provider';
...
export async function addApprovedClient(
  ...
  return `${approvedClientsCookieName}=${cookieValue}; HttpOnly; Secure; Path=/; SameSite=Lax; Max-Age=${String(THIRTY_DAYS_IN_SECONDS)}`;
}
